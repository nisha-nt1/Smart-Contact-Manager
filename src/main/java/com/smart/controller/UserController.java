...
//		model.addAttribute("user", user);
	...
	public String processContact(@ModelAttribute Contact contact, @RequestParam("profileImage") MultipartFile file,
		...
		try {
			...
			if (file.isEmpty()) {
				...
				// Save file to the folder and update the contact's image
			...
			System.out.println("Data saved to database: " + contact);
		...
		return "normal/add_contact_form"; // Make sure the template is rendered using the updated model
	}
	...
	/*
	 * @GetMapping("/show-contacts/{page}") public String
	 * showContacts(@PathVariable("page") Integer page, Model m, Principal
	 * principal) { m.addAttribute("title", "Show User Contacts");
	 * 
	 * //contact list send String userName = principal.getName();
	 * 
	 ...
	 * 
	 * m.addAttribute("contacts", contacts); m.addAttribute("currentPage", page);
	 * 
	 * m.addAttribute("totlaPages", contacts.getTotalPages());
	 * 
	...
	public String showContacts(@PathVariable("page") Integer page, Model m, Principal principal) {
	    ...
	    // Fetch user by principal
	    String userName = principal.getName();
	    User user = this.userRepository.getUserByUserName(userName);

	    // Set pagination with 5 items per page
	    Pageable pageable = PageRequest.of(page, 5);

	    // Fetch contacts for the user with pagination
	...
	public String deleteContact(@PathVariable("cid") Integer cId, Model model, HttpSession session, Principal principal) {
		...
		//check...Assignment
		System.err.println("Contact "+ contact.getcId());
	...
	public String updateHandler(@ModelAttribute Contact contact, @RequestParam("profileImage") MultipartFile file, Model m, HttpSession session, Principal principal) {
		...
		System.err.println("Contact Id "+contact.getcId());
	...
	public String changePassword(@RequestParam("oldPassword") String oldPassword, @RequestParam("newPassword") String newPassword, Principal principal, HttpSession session, Model model) {
		...
		System.err.println(currentUser.getPassword());
